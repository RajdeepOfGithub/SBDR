...
| # | Dataset | Size | Feeds Into | Phase Used | Link |

|---|---------|------|-----------|------------|------|

| 1 | Lending Club | 2.26M rows | XGBoost (demographics + credit features) | A, B | [Kaggle](https://www.kaggle.com/datasets/wordsforthewise/lending-club) |

| 2 | UCI Credit Card | 30K rows | BiLSTM (sequences) + XGBoost (features) + Fairness Audit | A, B, C | [UCI](https://archive.ics.uci.edu/ml/datasets/default+of+credit+card+clients) |

| 3 | Sparkov Synthetic | 1.3M+ txns | Feature Engineering (spending profiles) | A, B | [Kaggle](https://www.kaggle.com/datasets/kartik2112/fraud-detection) |

| 4 | Financial PhraseBank | 4,840 sentences | FinBERT fine-tuning (primary) | B | [HuggingFace](https://huggingface.co/datasets/takala/financial_phrasebank) |

| 5 | Mental Health Sentiment | CSV | FinBERT fine-tuning (secondary) + text mapping | A, B | [Kaggle](https://www.kaggle.com/datasets/suchintikasarkar/sentiment-analysis-for-mental-health) |

| 6 | Reddit Financial Sentiment | Time-series | Synthetic chat style guide + vocabulary reference | A, B | [ScienceDirect](https://www.sciencedirect.com/science/article/pii/S2352340922009623) / [Mendeley](https://data.mendeley.com/datasets/b6ns6d8xv3/3) |
